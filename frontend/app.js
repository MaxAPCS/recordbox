class MusicLibrary {
    ...
    async loadTracks() {
        try {
            const response = await fetch(`/trackls`);
    ...
    async loadTrackMetadata(card, provider, id) {
        try {
            const response = await fetch(`/track/${provider}/${id}`);
    ...
    async handleAddTrack(e) {
        ...
        try {
            const response = await fetch(`/trackadd`, {
                method: 'POST',
    ...
    async showAutotagModal(provider, id) {
        ...
        try {
            const response = await fetch(`/track/${provider}/${id}/autotag`);
